...
const Home = ({ setRoute, setSpectacle }) => (
  <>
    ...
    <section style={{ position:"relative", overflow:"hidden", background:"var(--terra)", color:"var(--paper)", minHeight:"min(78vh, 720px)", display:"flex", alignItems:"center" }}>
      <div style={{ position:"absolute", right:0, top:0, height:"100%", width:"62%", opacity:0.95 }}>
      ...
      <div style={{ position:"relative", zIndex:2, padding:"72px var(--pad-x)", maxWidth:680 }}>
        <div className="eyebrow" style={{ color:"var(--amber)", marginBottom:24 }}>Saison 2025 — 2026 · Toulon & tournée</div>
        <h1 className="display" style={{ fontSize:"clamp(60px, 9vw, 128px)", marginBottom:28, color:"var(--paper)" }}>
          ...
          <br/>corps & <span className="display-italic">voix</span>.
        </h1>
        <p style={{ fontSize:19, lineHeight:1.55, color:"color-mix(in oklab, var(--paper) 88%, transparent)", textWrap:"pretty", maxWidth:480, marginBottom:32 }}>
    ...
    <section className="section">
      <div className="section-head">
        ...
        <div className="section-meta">Six créations en répertoire, du conte musical au théâtre brut. <a onClick={() => setRoute("spectacles")} style={{ borderBottom:"1px solid currentColor", cursor:"pointer" }}>Tous les spectacles →</a></div>
      </div>
      <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:"var(--grid-gap)" }}>
        {SPECTACLES.slice(0,4).map((s,i) => (
          <SpectacleCard key={s.id} s={s} variant={i % 4} onClick={() => { setSpectacle(s.id); setRoute("spectacles/detail"); }}/>
        ))}
      </div>
    </section>
    ...
    <section className="section" style={{ background:"var(--paper-warm)" }}>
      <div className="section-head">
        ...
        <div className="section-meta">Une saison de tournée entre Provence, Languedoc et Avignon. <a onClick={() => setRoute("agenda")} style={{ borderBottom:"1px solid currentColor", cursor:"pointer" }}>Calendrier complet →</a></div>
      </div>
      <div style={{ display:"flex", flexDirection:"column" }}>
        {AGENDA.slice(0,5).map((d,i) => (
          <AgendaRow key={i} d={d} onClick={() => { setSpectacle(d.spectacle); setRoute("spectacles/detail"); }}/>
        ))}
      </div>
    </section>
    ...
    <section className="section" style={{ background:"var(--aubergine)", color:"var(--paper)", position:"relative", overflow:"hidden" }}>
      <div className="motif-bg" style={{ right:-100, top:-80, opacity:0.4 }}>
...
const SpectacleCard = ({ s, variant=0, onClick }) => (
  <article className="card" onClick={onClick} style={{ cursor:"pointer", background:"transparent", border:"none" }}>
    ...
    <div style={{ padding:"16px 4px 8px", display:"flex", justifyContent:"space-between", alignItems:"baseline", borderTop:"1px solid var(--rule)", marginTop:12 }}>
      <div>
        ...
        <h3 className="display" style={{ fontSize:24, lineHeight:1.05 }}>{s.title}</h3>
      </div>
  ...
  return (
    <>
      <section className="section" style={{ position:"relative", overflow:"hidden" }}>
        <div className="motif-bg" style={{ right:-50, top:0, opacity:0.3 }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"var(--grid-gap)" }}>
          {list.map((s,i) => (
            <SpectacleCard key={s.id} s={s} variant={i} onClick={() => { setSpectacle(s.id); setRoute("spectacles/detail"); }}/>
          ))}
        </div>
      </section>
    </>
...
const Agenda = ({ setRoute, setSpectacle }) => {
  ...
  return (
    <section className="section" style={{ position:"relative", overflow:"hidden" }}>
      <div className="motif-bg" style={{ right:-80, top:80, opacity:0.25 }}>
...
const Ateliers = () => {
  ...
  return (
    <>
      <section className="section" style={{ position:"relative", overflow:"hidden" }}>
        <div className="motif-bg" style={{ left:-60, top:0, opacity:0.3 }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"var(--grid-gap)" }}>
          {ATELIERS.map(a => (
            <article key={a.num} className="noise" style={{ background:a.color, color:a.textColor, padding:32, position:"relative", overflow:"hidden", minHeight:340, cursor:"pointer", display:"flex", flexDirection:"column", justifyContent:"space-between" }}
...
const Partenaires = () => {
  ...
  return (
    <section className="section" style={{ position:"relative", overflow:"hidden" }}>
      <div className="motif-bg" style={{ right:-50, bottom:-100, opacity:0.3 }}>
...
const Contact = () => {
  ...
  return (
    <>
      <section className="section" style={{ position:"relative", overflow:"hidden" }}>
        <div className="motif-bg" style={{ left:-100, top:-50, opacity:0.35 }}>
